...
let numeroUsuario = parseInt(prompt("Ingresa un número entre 1 y 50"));
let pokemonsMultiplos = [];

for (let i = 0; i < pokemons.length; i++) {
  if ((i + 1) % 5 === 0 && (i + 1) <= numeroUsuario) {
    pokemonsMultiplos.push(pokemons[i]);
  }
};

console.log("Pokémon múltiplos de 5 hasta el número", numeroUsuario + ":");
console.log(pokemonsMultiplos);
